...
// $Id: joomselect.php 3675 2012-03-04 14:58:48Z erftralle $
/******************************************************************************\
**   JoomGallery 2                                                            **
...
class JHTMLJoomSelect
{
   ...
   * @since   1.5.5
   */
  public static function users($name, $active, $nouser = false, $additional = array(), $javascript = null, $reg = false, $multiple = 6, $idtag = false)
  {
    $db     = JFactory::getDBO();
