...
// $Id: joomgallery.php 3675 2012-03-04 14:58:48Z erftralle $
/******************************************************************************\
**   JoomGallery 2                                                            **
...
<?php
   ...
   */
  public static function catTreeRecurse($mode, $id, $indent = '&nbsp;&nbsp;&nbsp;', &$list, &$children)
  {
    if($mode == 1)
    {
   ...
   */
  public static function categoryPath(&$catid)
  {
